...
\tgl
		...
		{\textsc{def} book \textsc{loc} \textsc{top} be\_as\_follows \textsc{adv} write \textsc{conn} \textsc{exist} \textsc{pst} \textsc{ind}}
...
\tgl
		...
		{Talked about bridge, golf, politics or neckties.}
\end{example}
...
\tgl
		...
		{then	\textsc{def}	adult	\textsc{top}	very	steadfastness	\textsc{vbz}	\textsc{adj}	youth	\textsc{acc}	know	\textsc{conn}	become	\textsc{rel.pst}	thing	\textsc{acc}	greatly	rejoice	\textsc{pst}	\textsc{ind}}
